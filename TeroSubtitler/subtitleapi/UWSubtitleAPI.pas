...
uses
  ...
  UWSystem.FileUtils,
  UWSubtitleAPI.Tags,
  UWSubtitleAPI.Formats.ABCiView,
  UWSubtitleAPI.Formats.AdobeEncoreDVD,
  UWSubtitleAPI.Formats.TimedText,
  UWSubtitleAPI.Formats.AdvancedSubstationAlpha,
  UWSubtitleAPI.Formats.AdvancedSubtitles,
  UWSubtitleAPI.Formats.AQTitle,
  UWSubtitleAPI.Formats.AvidCaption,
  UWSubtitleAPI.Formats.WebVTT,
  UWSubtitleAPI.Formats.CheetahCaption,
  UWSubtitleAPI.Formats.MicroDVD,
  UWSubtitleAPI.Formats.DRTIC,
  UWSubtitleAPI.Formats.EBU,
  UWSubtitleAPI.Formats.Captions32,
  UWSubtitleAPI.Formats.CaptionsInc,
  UWSubtitleAPI.Formats.Cheetah,
  UWSubtitleAPI.Formats.Cavena890,
  UWSubtitleAPI.Formats.CPC600,
  UWSubtitleAPI.Formats.DKS,
  UWSubtitleAPI.Formats.DVDJunior,
  UWSubtitleAPI.Formats.DVDSubtitleSystem,
  UWSubtitleAPI.Formats.DVDSubtitle,
  UWSubtitleAPI.Formats.FABSubtitler,
  UWSubtitleAPI.Formats.GPACTTXT,
  UWSubtitleAPI.Formats.NetflixTimedText,
  UWSubtitleAPI.Formats.IAuthor,
  UWSubtitleAPI.Formats.InscriberCG,
  UWSubtitleAPI.Formats.JACOSub,
  UWSubtitleAPI.Formats.KaraokeLyricsLRC,
  UWSubtitleAPI.Formats.KaraokeLyricsVKT,
  UWSubtitleAPI.Formats.MacDVDStudioPro,
  UWSubtitleAPI.Formats.MacSUB,
  UWSubtitleAPI.Formats.MPlayer,
  UWSubtitleAPI.Formats.MPlayer2,
  UWSubtitleAPI.Formats.SubViewer,
  UWSubtitleAPI.Formats.Sofni,
  UWSubtitleAPI.Formats.SpruceSubtitleFile,
  UWSubtitleAPI.Formats.ITunesTimedText,
  UWSubtitleAPI.Formats.TeroSubtitler,
  UWSubtitleAPI.Formats.CSV,
  UWSubtitleAPI.Formats.Spreadsheet,
  UWSubtitleAPI.Formats.TSV,
  UWSubtitleAPI.Formats.SubRip;
